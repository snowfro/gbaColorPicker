...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize directly - parent script is already loaded because of our new loading mechanism
    ...
    function initializePixelEditor() {
        try {
            ...
            if (!ctx || !canvasContainer || !selectedColorPreview) {
            ...
            console.error("Error initializing pixel editor:", error);
        }
    }
}); 